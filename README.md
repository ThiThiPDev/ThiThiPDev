  ...
  <table>
    <tr>
      <td width="450px">
        <p align="center">
          <sub>
            Estou trilhando meu caminho como um Desenvolvedor Full Stack, explorando sempre as áreas de Ciência da Computação e Engenharia de Software. Busco aprimorar minhas habilidades na criação de aplicações web, transformando aprendizado em projetos práticos e fazer deles repósitorios para acompanhar minha evolução.
            <br>
          </sub>
        </p>
        <p align="center">
